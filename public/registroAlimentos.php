...
<body class="bg-fondoGris">
    ...
    <div class="flex w-full h-screen">
        ...
        <div class="ml-10">
        <div class="bg-white sm:w-4/5 border ml:2 mr:2 mb-5 sm:mr-5 sm:mb-10 shadow-lg shadow-gray-500/50 border-slate-400 rounded-xl">
        <div class="m-4">    
        <div class="flex flex-col">
            <label for="Tipo">Tipo de alimento</label>
            <select name="tipo_alimento" id="tipo_alimento" class="border-2 border-black rounded-md" onchange="ocultar()">
        ...
        <div class="flex flex-col">
            ...
            <textarea name="Descripción alimento" id="" cols="30" rows="10"
                class="border-2 border-black resize-none rounded-md"></textarea>
        </div>

        <div class="mt-3 mb-3">
        <label for="Tipo">Unidad de medida</label>
        <select name="unidad_medida" id="unidad_medida" class="border-2 border-black rounded-md" onchange="ocultar()">
        ...
        <div class="flex flex-col mb-2">
            ...
            <input type="number" name="Cantidad porcion" min="1" max="100" placeholder="1" value="1"
                class="border-2 border-black p-1.5 rounded-md">
        </div>
        <div class="flex flex-col mb-2">
        ...
        <div>
            <input type="submit"
                class="bg-amarillo hover:bg-amber-300 text-black font-fuenteEslogan py-2 px-4 rounded cursor-pointer">
        </div>
