...
<div class="flex flex-col mb-2">
        ...
        <select name="Tipo_de_insulina_antes_ejercicio" id="Tipo_de_insulina_antes_ejercicio" class="border-2 border-black" onchange="ocultar()">
      ...
      <div class="flex flex-col mb-2">
        ...
        <select name="Alimento_antes_del_ejercicio" id="Alimento_antes_del_ejercicio" class="border-2 border-black" onchange="ocultar()">
      ...
      <div class="flex flex-col mb-2">
          <label for="Cantidad de carbohidratos antes del ejercicio" class="block mb-1 text-sm font-medium text-gray-900">Cantidad de carbohidratos antes del ejercicio</label>
          <input type="number" name="Cantidad de carbohidratos antes del ejercicio" min="1" max="100" placeholder="1" value="1" class="border-2 border-black p-1.5">
        </div>
        ...
        <div class="flex flex-col mb-2">
          <label for="Tipo de ejercicio" class="block mb-1 text-sm font-medium text-gray-900">Tipo de ejercicio</label>
            ...
            <select name="intencidad_del_ejercicio" id="intencidad_del_ejercicio" class="border-2 border-black" onchange="ocultar()">
