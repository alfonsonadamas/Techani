        ...
        <div class="flex w-full h-screen">
            ...
            <div class="w-full">
                ...
                <div class="ml-8 mt-10">
                   ...
                   <div class="ml-6 mt-7">
                        <button class="border border-black p-2 rounded-lg hover:bg-gray-200 " id="agregar"> + Agregar Análisis </button>
                   </div>

                   <div id="form" class="hidden mb-14"> 
                        <form action="" class="border border-gray-400 w-2/4 rounded-lg my-7 ml-20 shadow-xl drop-shadow-lg p-6 flex flex-col items-center">
                            <div class="flex mb-8"> 
