    ...
    <div class="flex justify-center items-center h-screen w-full">
        ...
        <div class="flex flex-col justify-center items-center bg-white h-4/6 w-3/12 rounded-3xl ml-10">
            ...
            <form action="" class="flex flex-col items-center" id="login">
                <input class="rounded-3xl border-solid border-2 border-black py-2 px-2 mb-5 w-72" type="email"
                    placeholder="Correo Electronico" name="correo">
                <input class="rounded-3xl border-solid border-2 border-black px-2 py-2 mb-5 w-72" type="password"
