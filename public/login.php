...
<body class="bg-azul">
    <div class="flex justify-center items-center h-screen w-full">
        ...
        <div class="flex flex-col justify-center items-center bg-white h-4/6 w-3/12 rounded-3xl ml-10">
            <h2 class="font-fuenteTechani mb-8  text-2xl">INICIAR SESION</h2>
            <form action="" class="flex flex-col items-center" id="login">
                <input class="rounded-3xl py-2 mb-5 w-72" type="email" placeholder="Correo Electronico" name="correo">
                <input class="rounded-3xl py-2 mb-5 w-72" type="password" placeholder="Contraseña" name="contrasena">
                <p class="text-red-600 hidden" id="alerta">Correo o contraseña incorrectos</p>
                <p class="mb-5">¿No tines cuenta? <a class="text-azulBorde font-bold underline" href="">Registrate</a>
                </p>
