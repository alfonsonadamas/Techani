            ...
            <div class="flex flex-col mx-6">
              <div class="w-full">
                ...
                <div class="sm:w-4/5 sm:flex sm:flex-col">
                  <h2 class="text-left mb-10 mt-10 font-size text-2xl text-black font-sans">Registros Anteriores</h2>
                      <div class="flex">
                        <h1>Fecha:</h1>
                      ...
                      <div class="sm:flex sm:flex-wrap justify-between flex flex-wrap shadow-lg shadow-gray-500/50 border-slate-400 rounded-xl p-4" id="registros">
                        ...
                        ?>
                        <p id="sinRegistros" style="display: none; color: red; font-weight: bold;">No hay registros en esta fecha.</p>
                          <div class="registro sm:flex sm:mb-2 mb-2 sm:flex-col sm:flex-wrap justify-center items-center">
