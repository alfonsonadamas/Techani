    ...
    <form action="php/addRegistro.php" method="post" class="sm:flex sm:flex-row">
        <div>
            <div class="flex flex-col items-center mb-2 ">
                <label for="tipo_insulina" class="block mb-1 text-sm font-medium text-gray-900 ">Tipo de
                    Insulina</label>
                <select name="tipo_insulina" id=""
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-1.5 w-1/2">
            ...
            <div class="flex flex-col mb-2">
                ...
                <input type="number" name="dosis" min="1" max="25" placeholder="1" value="1"
        ...
        <div>
            <div class="flex flex-col">
                ...
                <input type="number" name="vasos_agua" min="0" max="20" placeholder="0" value="0"
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="especifique" placeholder="Especifique"
                    class="hidden border-2 border-black resize-none ">
