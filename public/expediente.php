    ...
    <form action="procesar_formulario.php" class="sm:w-11/12 " method="post">
       ...
       <div id="card1" class="border mb-5 sm:mt-10 shadow-lg bg-white shadow-gray-500/50 border-slate-400 rounded-xl">
            ...
            <div class="ml-4 mr-4 flex mb-2 flex-col">
                ...
                <input type="text" name="nombre_padre_tutor" class="bg-gray-50 border border-gray-300 text-gray-900 p-1 text-sm rounded-lg block">
            </div>
            ...
            <div class="ml-4 mr-4 flex mb-2 flex-col">
                ...
                <div class="flex flex-row items-center">
                    <input class="w-4 h-4 mr-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="sexo" value="Masculino" class="mr-2"> Masculino
       ...
       <div id="buttonC2">
        ...
        <div id="card3" class="border mb-5 sm:mt-10 shadow-lg bg-white shadow-gray-500/50 border-slate-400 rounded-xl">
            ...
            <div class="ml-4 mr-4 flex mb-2 flex-col">
                ...
                <input type="text" name="hemoglobina_glicosilada" class="bg-gray-50 border border-gray-300 text-gray-900 p-1 text-sm rounded-lg block">
